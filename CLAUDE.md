...
1. Read `../Nexus_OV/iCELL_OV/Home.md` — master index
2. Read `../Nexus_OV/iCELL_OV/Current.md` — **live focus; trust this over Home.md**
...
## Session End Ritual
1. Append a dated note to `../Nexus_OV/iCELL_OV/Sessions/` using `Templates/Session Note.md`
2. Update `../Nexus_OV/iCELL_OV/Current.md` if focus, blockers, or next steps shifted
