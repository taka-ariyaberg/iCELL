/** SVG generators for the plate-layout and dye-program exports.
 *
 * Two public entry points:
 * - `generateLayoutSVG` — cell-group view of the plate.
 * - `generateDyeSVG`    — dye-program view of the plate.
 *
 * Helpers (`svgDefs`, `svgWell`, etc.) are file-local and intentionally
 * kept here because they only make sense in the context of these two
 * generators.
 */

import { generateColors, generateDyeColor } from './colorPalette';
